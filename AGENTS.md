...
The [`docs/`](docs/) folder is the source of truth for how this frontend is built
and why. **Read it before writing code, and keep it updated as part of "done".**

- [`docs/README.md`](docs/README.md) — start here
- [`docs/architecture.md`](docs/architecture.md) — folder layout, rendering model, data flow
